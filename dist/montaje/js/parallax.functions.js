...
(function ($) {
    "use strict";
	var $retadores = $("#slider-retadores"),
		$regularidad = $("#slider-regularidad"),
		$regional = $("#slider-regional"),
		$convencion = $("#slider-convencion");
    ...
    var sl_retadores = $retadores.bxSlider({
        pagerCustom: '#pager',
        nextText: chevron_right,
        prevText: chevron_left,
        mode: 'fade'
	 ...
	 var sl_regularidad = $regularidad.bxSlider({
        pagerCustom: '#pager',
        nextText: chevron_right,
        prevText: chevron_left,
        mode: 'fade'
	...
	var sl_regional = $regional.bxSlider({
        pagerCustom: '#pager',
        nextText: chevron_right,
        prevText: chevron_left,
        mode: 'fade'
	...
	var sl_convencion = $convencion.bxSlider({
        pagerCustom: '#pager',
        nextText: chevron_right,
        prevText: chevron_left,
        mode: 'fade'
    ...
    function resize() {
        ...
        if (responsive) {
            ...
            if ($(window).width() > 480 && $(window).height() > 480) {
                ...
                if ($retadores.length) {
                    sl_retadores.reloadSlider();
                }
				
				if ($regional.length) {
                    sl_regional.reloadSlider();
                }
				
				if ($regularidad.length) {
                    sl_regularidad.reloadSlider();
                }
				
				if ($convencion.length) {
                    sl_convencion.reloadSlider();
                }
            }
            ...
            //If window width and height is < 480, just destroy slider and show normal content
               ...
               if ($retadores.length) {
                    sl_retadores.destroySlider();
                }
				
				if ($regional.length) {
                    sl_regional.destroySlider();
                }
				
				if ($regularidad.length) {
                    sl_regularidad.destroySlider();
                }
				
				if ($convencion.length) {
                    sl_convencion.destroySlider();
                }
